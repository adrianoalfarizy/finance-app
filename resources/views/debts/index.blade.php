<x-app-layout>
    ...
    <div class="p-4 space-y-4 pb-16">
        ...
        <a href="{{ route('debts.create') }}" class="px-3 py-2 bg-blue-600 text-white rounded-lg block text-center">+ Catat Hutang</a>
        ...
        <div class="bg-white rounded-2xl shadow p-4 space-y-3 overflow-hidden">
            ...
            <form method="post" action="{{ route('debts.payments.store',$d) }}"
                ...
                <input name="amount" type="number" step="0.01" min="0"
                       ...
                       placeholder="Jumlah angsuran" aria-label="Jumlah angsuran">
